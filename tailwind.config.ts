...
/**
 * Tailwind consumes ONLY semantic/component tokens (CSS variables defined in
 * globals.css). No raw hex or px values live here — every colour, radius, shadow and
 * font resolves through `hsl(var(--token))` so the three-layer token system stays the
